...
import com.ys.myapp.config.KafkaProperties;
...
class JhipsterMicroApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterMicroApplicationKafkaResource kafkaResource = new JhipsterMicroApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc.perform(post("/api/jhipster-micro-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/jhipster-micro-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
