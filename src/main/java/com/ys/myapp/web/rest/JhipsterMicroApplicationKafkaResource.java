...
@RestController
@RequestMapping("/api/jhipster-micro-application-kafka")
public class JhipsterMicroApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterMicroApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterMicroApplicationKafkaResource(KafkaProperties kafkaProperties) {
